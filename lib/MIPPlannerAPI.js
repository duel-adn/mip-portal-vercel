 ...
 * L'identificare deve coincidere con un valore di MIPLegMode.
 * I colori scelti sono stati selezionati per essere distinguibili
 * da persone con diverse forme di daltonismo.
 */
export const MIPLegColor = {
    "Walk": "#666",
    "Bycicle": "#117733",
    "Vehicle": "#333",
    "Bus": "#003C86",
...
export async function mipReverseGeocode(lang, longitude, latitude) {
    lang = lang ?? 'it'
    const response = await mipFetch('/api/reverse', {
